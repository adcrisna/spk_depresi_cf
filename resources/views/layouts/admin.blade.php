                ...
                <ul class="sidebar-menu">
                    ...
                    <li>
                        <a href="{{ route('admin.gejala') }}">
                            <i class="fa fa-list-alt"></i> <span>Data Gejala</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.aturan') }}">
                            <i class="fa fa-list"></i> <span>Data Aturan</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('admin.diagnosis') }}">
                            <i class="fa fa-edit"></i> <span>Data Diagnosis</span>
                        </a>
                    </li>
                    <li>
